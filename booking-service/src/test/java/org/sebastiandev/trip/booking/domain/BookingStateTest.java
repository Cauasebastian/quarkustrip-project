...
class BookingStateTest{
 ...
 @Test void compensationWaitsForPendingFinancialOperations(){assertFalse(PaymentState.PENDING.settledForCompensation());assertFalse(PaymentState.SUCCEEDED.settledForCompensation());assertFalse(PaymentState.REFUND_PENDING.settledForCompensation());assertTrue(PaymentState.NOT_REQUESTED.settledForCompensation());assertTrue(PaymentState.FAILED.settledForCompensation());assertTrue(PaymentState.REFUNDED.settledForCompensation());}
}
